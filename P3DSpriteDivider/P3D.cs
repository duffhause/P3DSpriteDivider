...
namespace P3DSpriteDivider
{
	public partial class P3D
    {
        ...
        public Chunk RecalculateChunk(Chunk currentChunk, byte[] newData)
		{
            int fullChunkSize = 0;
        ...
        private Chunk GetChunk ( byte[]data, int offset, int idx)
		{
        ...
        public void ReadP3D(string path)
        {
            ...
            Reader.Close();
            Root = GetChunk(uncompressedData, 0, 0);
        }
        ...
        public void WriteP3D(string path)
        {
            ...
            byte[] output = new byte[Root.FullChunkSize];
            
            Array.Copy(PackChunk(Root), 0, output, 0, Root.FullChunkSize);
