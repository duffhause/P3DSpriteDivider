...
namespace P3DSpriteDivider
{
	public partial class P3D
	{
        ...
        public static ImageDataStruct CalculateImageData (ImageDataStruct imageData, Bitmap image, string name)
        {
            imageData.width = image.Width;
            imageData.height = image.Height;
            imageData.bitDepth = Image.GetPixelFormatSize(image.PixelFormat);
            imageData.palaetised = 0; //Calculate TODO
            imageData.hasAlpha = Image.IsAlphaPixelFormat(image.PixelFormat) ? 1 : 0;
            imageData.format = 1;
            imageData.version = 14000; //Calculate TODO
            imageData.Name = name;
